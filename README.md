# linkedin-hide-ads-and-premium-mentions-userstyle-css
...
- [ ] View complete profile descriptions
...
- [ ] userscript port, so it can be used on browsers that only support userscripts (Tampermonkey can be installed on Safari mobile ?)
...
- [ ] Fetches the style updates from the api link https://userstyles.world/api/style/25558
